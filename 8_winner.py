...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Player    A : 0                 Player    B : 0", align="center", font=("ARCADECLASSIC", 24, "normal"))
...
while True:
    ...
    if ball.xcor() > 390:
        ...
        score_a += 1
        pen.clear()
        pen.write(f"Player    A : {score_a}                 Player    B : {score_b}", align="center", font=("ARCADECLASSIC", 24, "normal"))
    ...
    if score_a == 3:
        ...
        restart.goto(0, -50)
        restart.write("regame press r", align="center", font=("press start k", 25, "normal"))